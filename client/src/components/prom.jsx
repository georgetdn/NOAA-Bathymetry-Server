    ...
    return (
        <PageLayout>
            <h1>FOR A LIMITED TIME ONLY!<sup><b>*</b></sup></h1>
             For websites samles ($300.00) go <a href="https://y219.com/services#bottom-services">here</a>
            ...
            <ul className="services-list">
                ...
                <li><strong>Basic site (5-10 pages) </strong>  $<s>150</s> – $<s>300</s> (Waived for first time customers)</li>
                <li><strong>Blog site (5-10 pages) </strong> $250 - $500 (WordPress)</li>
